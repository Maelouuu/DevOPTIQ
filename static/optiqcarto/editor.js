...
async function importVSDX(file) {
  ...
  try {
    ...
    // flèches (mesuré sur hard.vsdx : plus de coudes, arrows enmêlées) pour un gain
    // faible. On revient au comportement « losanges seatés sur la flèche la plus
    // proche » (_seatFloatingDecisions, post-routage), moins invasif.
