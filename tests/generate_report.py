...
PAGE_LABELS = {
    ...
    "test_60_activity_items_api":        "API Agrégée Savoirs/Savoir-Faire/HSC par Activité",
    "test_61_propose_common":            "Utilitaires Communs Propositions IA (Contexte & Fallback)",
}
