...
PAGE_LABELS = {
    ...
    "test_48_carto_package":             "Cartographie — Export/Import de Package",
    "test_48_set_password_admin":        "Définition de Mot de Passe Admin",
    "test_49_carto_dom_contract":        "Cartographie — Contrat DOM Éditeur",
    ...
    "test_51_entity_share":              "Partage d'Entités entre Comptes",
